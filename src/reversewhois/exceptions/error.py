...
class ReverseWhoisApiError(Exception):
...
class ParameterError(ReverseWhoisApiError):
    pass


class EmptyApiKeyError(ReverseWhoisApiError):
    pass


class ResponseError(ReverseWhoisApiError):
    def __init__(self, message):
        self.message = message
...
class UnparsableApiResponseError(ReverseWhoisApiError):
...
class HttpApiError(ReverseWhoisApiError):
    pass
